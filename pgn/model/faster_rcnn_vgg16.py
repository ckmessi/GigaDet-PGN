...
from pgn.model.faster_rcnn import FasterRCNN
from pgn.model.patch_generation_network import PatchGenerationNetwork
...
class VGG16RoIHead(torch.nn.Module):
    ...
    def forward(self, x, rois, roi_indices):
        ...
        #     pool = pool.view(pool.size(0), -1)
        # else:
        #     pool = pool.reshape(0, pool.size(1) * pool.size(2) * pool.size(3) )
