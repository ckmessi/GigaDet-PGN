...
from pgn.config.cfg_node import get_cfg
from pgn.utils.logger import DEFAULT_LOGGER, setup_logger


def default_argument_parser():
    parser = argparse.ArgumentParser(description="PGN Training")
